...
from backend.schemas.auth import LoginResponse, UserLogin
from backend.schemas.user import CreateUserRequest, UserLoginResponseAuth, UserResponse
...
)  # Changed from /create/admin to /users/admin
